...
sub = dict([l.strip('\n').split('\t') for l in open('tmp/sub_name_map.txt','rU')])
...
for mname,ml in merged:
    ...
    sdata[mname]['alias'] = sub[mname] if mname in sub else ''
